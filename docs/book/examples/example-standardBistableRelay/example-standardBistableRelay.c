...
//
// File:    example-standardBinstableRelay.c
...
// This example implements 2 binary outputs according to the IQRF Binary Outputs standard
// both outputs manage bi-stable relay of IQRFBB-10 Development Board
// Index 0: Relay #1 @ Bi-stable relay C1
// Index 1: Relay #2 @ Bi-stable relay C2
